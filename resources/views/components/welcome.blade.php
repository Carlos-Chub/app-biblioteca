<div
    ...
    <h1 class="text-center mt-8 text-2xl font-medium text-gray-900 dark:text-white">
        ¡Bienvenido a Biblioteca <span class="font-bold">Bernando Lemus</span>!
    </h1>
...
<div class="bg-gray-200 dark:bg-gray-800 bg-opacity-25 grid grid-cols-1 p-6 lg:p-8">
    {{-- <div>
    ...
    <div class="flex items-center justify-center">
        <img class="block w-1/2 sm:w-1/3" src="{{ url(asset('assets/img/logo3.png')) }}" alt="Logo">
    </div>
</div>
