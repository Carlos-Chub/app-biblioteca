<div>
    <div class="max-w-7xl mx-auto py-10 sm:px-6 lg:px-8">
        <x-slot name="header">
            <div class="flex items-center justify-between">
                ...
                <a type="button" href="{{ route('book-reader.create') }}"
        ...
        <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-xl sm:rounded-lg">
            <div class="p-6 lg:p-8 bg-white border-b dark:bg-gray-800 border-gray-200 dark:border-gray-700">
                <livewire:book-readers.book-reader-table />
            </div>
        </div>
    </div>
    <x-confirmation-modal wire:model="showDeleteModal">
        ...
        <x-slot name="content">
            {{ __('¿Quieres eliminar el registro: ' . $DeleteSelected . ', esta acción es irreversible?') }}</x-slot>
        <x-slot name="footer">
